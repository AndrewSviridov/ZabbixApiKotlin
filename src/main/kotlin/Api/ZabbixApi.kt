...
class ZabbixApi(private var apiUrl: String, login: String, password: String) {
     ...
     *
     * Return  MutableList<ResponseEvent.Result> with a 'hosts' property with hosts containing the object that created the event.
     * Supported only for events generated by triggers, items or LLD rules.
     * **/
    @Throws(ZabbixApiException::class)
    fun getProblemHosts(eventid: String): MutableList<ResponseEvent.Result> {
